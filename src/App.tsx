...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    problem: "A retail brand needed to increase their organic reach and engagement on Instagram and Facebook.",
    solution: "Developed a series of high-impact visual posts and stories using AI-generated backgrounds and custom typography.",
    result: "Achieved a 200% increase in monthly engagement and 15% growth in follower count within 3 months.",
    tags: ["Social Media", "Canva", "AI Art"],
    ...
    <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'glass py-4' : 'bg-transparent py-6'}`}>
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        <a href="#" className="text-2xl font-bold font-display tracking-tighter">
          JUHI<span className="text-indigo-500">.</span>
        </a>
      ...
      >
        ...
        <div className="absolute -top-6 -right-6 glass p-6 rounded-2xl border border-white/10 shadow-2xl">
          <div className="flex gap-1 mb-1">
            {[1,2,3,4,5].map(i => <Sparkles key={i} size={12} className="text-indigo-400" />)}
          </div>
          <p className="text-sm font-bold">AI-Powered Workflow</p>
        </div>
      </motion.div>
    </div>
  </section>
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[300px] md:auto-rows-[350px]">
        ...
        >
          ...
          {/* Subtle hover overlay to indicate interactivity without blocking native controls */}
          <div className="absolute inset-0 bg-black/10 group-hover:bg-transparent transition-colors pointer-events-none" />
          
          {/* View Project Link - Visible on hover */}
          <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-30 opacity-0 group-hover:opacity-100 transition-opacity">
            <a 
              href={PROJECTS[4].link}
              className="px-6 py-2 rounded-full glass border border-white/10 text-xs font-bold hover:bg-white hover:text-black transition-all"
            >
              View Project
            </a>
          </div>
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-6 pt-8">
                <a href="#" className="w-12 h-12 rounded-full glass border border-white/10 flex items-center justify-center hover:bg-white hover:text-black transition-all">
                  <Linkedin size={20} />
                </a>
                <a href="#" className="w-12 h-12 rounded-full glass border border-white/10 flex items-center justify-center hover:bg-white hover:text-black transition-all">
                  <Github size={20} />
          ...
          <form className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input type="text" className="w-full bg-zinc-900/50 border border-white/10 rounded-2xl px-6 py-4 outline-none focus:border-indigo-500 transition-all" placeholder="Your Name" />
              </div>
              <div className="space-y-2">
                <label className="text-xs font-bold uppercase tracking-widest text-zinc-500">Email</label>
                <input type="email" className="w-full bg-zinc-900/50 border border-white/10 rounded-2xl px-6 py-4 outline-none focus:border-indigo-500 transition-all" placeholder="your@email.com" />
              </div>
            </div>
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-zinc-500">Message</label>
              <textarea rows={5} className="w-full bg-zinc-900/50 border border-white/10 rounded-2xl px-6 py-4 outline-none focus:border-indigo-500 transition-all" placeholder="How can I help you?" />
            </div>
            <button className="w-full py-5 bg-white text-black rounded-2xl font-bold text-lg hover:bg-zinc-200 transition-all">
              Send Message
            </button>
          </form>
        </div>
